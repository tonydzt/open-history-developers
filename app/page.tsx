      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        {documents.length === 0 && (
          <div className="text-center py-20">
            ...
            <p className="text-slate-500 dark:text-slate-400 text-lg">暂无文档</p>
            <p className="text-slate-400 dark:text-slate-500 text-sm mt-2">请稍后再来查看</p>
          </div>
        )}
      </div>
    </div>
